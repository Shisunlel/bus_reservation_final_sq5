...
public class Trip extends javax.swing.JPanel {
	Connection conn;
	Map<String, Integer> drivers = new HashMap<String,Integer>();
...
/**
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String vehicle_type = jTblTrip.getValueAt(row, 1).toString();
        String name = jTblTrip.getValueAt(row, 2).toString();
        String origin = jTblTrip.getValueAt(row, 3).toString();
        String destination = jTblTrip.getValueAt(row, 4).toString();
        String price = jTblTrip.getValueAt(row, 5).toString();
...
//(id,vehicle,type_id,name,origin,destination,price,status,created_at,updated_at)
				...
				for (String vehicle : vehicles.keySet()){
					Integer vehicle_id = vehicles.get(vehicle);
